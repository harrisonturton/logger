...
start:
  ...
  br i1 %0, label %panic.i, label %"_ZN4core3num21_$LT$impl$u20$u32$GT$10div_euclid17h7fac5b3b280d8b97E.exit"

panic.i:                                          ; preds = %start
; call core::panicking::panic
  call void @_ZN4core9panicking5panic17h927d7d5414d91376E(ptr align 1 @str.0, i64 25, ptr align 8 @alloc_b14a7464d3c8d37dcad6559bf40a2318) #3
  unreachable

"_ZN4core3num21_$LT$impl$u20$u32$GT$10div_euclid17h7fac5b3b280d8b97E.exit": ; preds = %start
  ret void
}
...
declare void @_ZN4core9panicking5panic17h927d7d5414d91376E(ptr align 1, i64, ptr align 8) unnamed_addr #2
